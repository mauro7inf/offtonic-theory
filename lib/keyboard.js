// Dependencies: audioplayer.js, globals.js, notes.js, tone.js, keyboardKey.js
...
Keyboard.prototype.setNoteNames = function (noteNames) {
  for (let i = 0; i < this.keys.length; i++) {
    this.keys[i].noteNames = noteNames;
  }
};